package cn.hejinyo.calm.common.basis.utils;
...
public class Tools {
     ...
     * 从主配置文件中获取value
     */
    public static String getProfileValue(String key, String defaultValue) {
        YamlPropertiesFactoryBean yaml = new YamlPropertiesFactoryBean();
        yaml.setResources(new ClassPathResource("application.yml"));
        return Objects.requireNonNull(yaml.getObject()).getProperty(key, defaultValue);
    }
